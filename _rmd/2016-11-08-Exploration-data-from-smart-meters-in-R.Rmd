...
Read meta data and show their structure. Of course, you must firstly set your working directory by `setwd("YOUR PATH")`, where smart meter data are.
...
Similarly, we can do this but now with week pattern. So lets make median weekly profile of aggregate consumption with MAD.
